...
public class Hunter extends Hero{
    ...
    public void fight(Combatant combatant) {
        if(arrow>0){
            ...
            arrow--;
            System.out.println("Il vous reste " + arrow + " flèches encore disponible");
        } else {
            System.out.println("Tu n'a plus de fleche");
        }
    }

    //@Override
    //public void afficherDegat(Combatant combatant){
      //  System.out.println("ndshb"+weapon.getDamagePoints());
    //}
